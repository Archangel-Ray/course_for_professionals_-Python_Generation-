...
list_letter = [input() for _ in range(3)]

print("ru" if all(map(lambda l: l in "АаВСсЕеНКМОоРрТХху", list_letter))
      else "en" if all(map(lambda l: l in "AaBCcEeHKMOoPpTXxy", list_letter)) else "mix")
